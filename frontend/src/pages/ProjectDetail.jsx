    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          width: '100%',
          height: '100%',
          background: 'radial-gradient(ellipse 80% 40% at 50% 50%, rgba(192,132,252,0.1) 0%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        <div style={{
          width: '48px',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                fontWeight: '200',
                letterSpacing: '2px',
              }}>{analysis.estimated_market_size}</p>
            </div>
            <div style={{
              padding: '32px',
              border: '1px solid rgba(192,132,252,0.1)',
        ...
        {activeTab === 'competitors' && (
          <div style={{
            ...
            {competitors.length === 0 ? (
              <p style={{ color: '#94A3B8' }}>No competitors found</p>
            ) : (
